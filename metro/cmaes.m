...
cmaVersion = '2.34'; 
% cmaes.m, Version 2.34b, last change: September, 21, 2005 
...
%     Setting SIGMA to half of the initial search region is
%     appropriate, e.g., the initial point in [0, 3]^10 and SIGMA=1.5
%     means cmaes('myfun', 3*rand(10,1), 1.5). (On the simplest
%     quadratic function f=sum(x.^2) optimal SIGMA equals roughly
...
defopts.TolFun       = '0e-12 % stop if fun-changes smaller TolFun';
